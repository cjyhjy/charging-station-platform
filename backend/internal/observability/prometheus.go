...
var metricHelp = map[string]string{
	...
	MetricOutboxOldestUnpublished:    "Age in seconds of the oldest unpublished outbox row, 0 when the outbox is empty.",
	MetricWorkerLastSuccess:          "Unix time of the last delivery the worker finished successfully.",
	MetricPublisherLastPublish:       "Unix time of the last publish pass that wrote at least one row.",
	MetricPublisherLockLossesTotal:   "Times the publisher found it no longer held the advisory lock.",
	MetricPublisherStandby:           "1 while this publisher is waiting for the lock another instance holds.",
	MetricPublisherPublishedTotal:    "Outbox rows this process published.",
	MetricPublisherPassFailuresTotal: "Publish passes that returned an error.",
